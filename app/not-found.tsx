  ...
  return (
    <div className="py-16 text-center">
      ...
      <div className="flex flex-wrap justify-center gap-3 text-sm">
        <Link
          href="/"
          className="px-4 py-2 rounded border border-amber text-amber hover:bg-amber hover:text-ground transition-colors"
        >
          Back to the Tap Room
        </Link>
        <Link
          href="/records"
          className="px-4 py-2 rounded border border-edge text-parch hover:text-amber hover:border-amber transition-colors"
        >
